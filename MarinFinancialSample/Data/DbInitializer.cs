    ...
    public static class DbInitializer
    {
        public static void Initialize(LibraryDbContext context)
        {
            ...
            var books = new Book[]
            {
                ...
                Isbn="9780765379528", AutherId=1,GenreId=3},
                ...
                Isbn="9780765379504", GenreId=3, AutherId=1},
                new Book{Title="The Name of the Wind (The Kingkiller Chronicle, #1)", AutherId=3, GenreId=1, Isbn="9781473211896", Summary="I have stolen princesses back from sleeping barrow kings. I burned down the town of Trebon. I have spent the night with Felurian and left with both my sanity and my life. I was expelled from the University at a younger age than most people are allowed in. I tread paths by moonlight that others fear to speak of during day. I have talked to Gods, loved women, and written songs that make the minstrels weep."}
